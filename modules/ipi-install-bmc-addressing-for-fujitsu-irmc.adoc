...
. The default value of `disableCertificateVerification` is `False`, for Fujitsu hardware you must include `disableCertificateVerification: True` in the `bmc` configuration.
====
